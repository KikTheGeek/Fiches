...
\section{Link to Github}
	...
	\code{git remote add RemoteName RemoteURL} add a location for your repository on github

	\code{git push RemoteName BranchName} save online after commit, main branch is usually master
