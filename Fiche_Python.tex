...
\end{lstlisting}
			...
			\code{predict\_{}proba()} returns a proba to be in the class for single-classification problem. The output is a $2 \times input-size$ array, with proba on column $[:,1]$.
